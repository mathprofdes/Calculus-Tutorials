...
The Clear Table option will replace the current table with a blank grid. The undo/redo history is not cleared so the table that is overwritten is still in the history.
