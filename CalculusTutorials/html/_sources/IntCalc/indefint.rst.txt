...
As an easy example, we know that :math:`\frac{d}{dx}\left( x^2 \right) = 2x`. Turning this around into the language of antiderivatives, an antiderivative of :math:`2x` is :math:`x^2`.  Notice that we are saying *an* antiderivative and not *the* antiderivative.  Note that :math:`x^2 + 1` is also an antiderivative of :math:`2x`, so is :math:`x^2 + 7`, :math:`x^2 -1234.5678`, :math:`x^2 + \frac{23}{47}` , and :math:`x^2 + \pi.`  In general, :math:`x^2 + C` is an antiderivative of :math:`2x` where *C* is any constant.
...
.. admonition:: Definition: The Indefinite Integral
...
.. figure:: Images/Int/IndefInt001.png
    :alt: Family of Solutions
...
.. figure:: Images/Int/IndefInt002.png
    :alt: Velocity Curve
...
.. figure:: Images/Int/IndefInt003.png
    :alt: Velocity and Distance Curves
...
.. figure:: Images/Int/IndefInt004.png
    :alt: Velocity and Distance Curves

    :math:`v(t) = - 6 \sin{\left(2 t \right)} + 6 \cos{\left(3 t \right)}` and :math:`s(t) = 2 \sin{\left(3 t \right)} + 3 \cos{\left(2 t \right)} + C`
...
.. figure:: Images/Int/IndefInt005.png
    :alt: Velocity and Distance Curves
...
.. figure:: Images/Int/IndefInt006.png
    :alt: Velocity and Distance Curves

    :math:`v(t) = - 6 \sin{\left(2 t \right)} + 6 \cos{\left(3 t \right)}` and :math:`s(t) = 2 \sin{\left(3 t \right)} + 3 \cos{\left(2 t \right)}`
