...
If you wish to edit the tutorials they were developed in Sphinx documentation package built with the PyData Sphinx Theme.  So you will need to have Python3, Sphinx, the PyData Sphinx Theme, and the copybutton installed on your system.
